...
require('lazy').setup({
  ...
  { -- Neotest
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>tp', "<cmd>lua require('neotest').output_panel_toggle()<CR>", { desc = 'Toggle Test Output Panel' })
      vim.keymap.set('n', '<leader>tl', "<cmd>lua require('neotest').run.run_last()<CR>", { desc = 'Run Last Test' })
      vim.keymap.set('n', '<leader>ts', "<cmd>lua require('neotest').summary_toggle()<CR>", { desc = 'Toggle Test Summary' })
    end,
  },
